...
static u8 TxBuff[ENET_BUFFER_SIZE];
...
/*******************************************************************************
* Function Name  : ENET_AutoNegotiation
* Description    : Start the autonegotiation protocol.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static s32 ENET_AutoNegotiation()
{
...
{
	if ( ENET_OperatingMode & PHY_AUTO_NEGOTIATION ) {
  	while ( !ENET_AutoNegotiation() )
		{
...
void ENET_Init (u32 operatingmode)
{
  ...
  if ( !(operatingmode & PHY_AUTO_NEGOTIATION) )
...
/*******************************************************************************
* Function Name  : pcGetNextBuffer
* Description    : Get a pointer to the first free transmission buffer.
* Return         : a pointer to a memory locationt where the application can
*                  copy the frame to be transmitted, or NULL if non buffer are
*                  available.
*******************************************************************************/
